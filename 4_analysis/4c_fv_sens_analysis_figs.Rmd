...
map_param <- function(df, s, p, r = ocean_r, thresh = .005) {
  sig_mtx <- df %>%
  ...
  if(!is.na(thresh)) val_rast[abs(val_rast) < thresh] <- NA
...
```{r map coefficient of variation in fv}
...
### Plots of CHI stats vs. number of species
...
ggsave('_figs/chi_stat_by_trait_scatter.png', width = 6, height = 3, dpi = 300)

knitr::include_graphics('_figs/chi_stat_by_trait_scatter.png')
