...
Identify areas with anomalous predictions of impact from habitat and spp based CHI methods, looking at the bar charts by region.  Possible areas include the Andaman Islands area?  
...
#### Low FE-based climate impacts on vulnerable FEs: Hawaii
...
#### High climate impacts on vulnerable FEs: Andaman Islands
...
## Check fishing pressure by cell
