...
The following is from a vignette posted at https://data-mermaid.github.io/mermaidr/articles/vo_baseline_monitoring.html and modified to test functionality and identify methods for accessing MERMAID data.
...
vo_projects <- mermaid_get_projects()
...
## Let's try accessing data more generally
...
write_csv(beltfish_all, here('_data/mermaid/beltfish_data.csv'))
```
...
write_csv(benthic_pit_all, here('_data/mermaid/benthic_pit_data.csv'))
```
...
write_csv(benthic_lit_all, here('_data/mermaid/benthic_lit_data.csv'))
```
