...
diff_df <- spp_vs_fe_df %>%
  ...
  mutate(diff_cat = case_when(diff <  -50 ~ '$I_{spp}^C > 1.5 \\times I_{FE}^C$',
                              diff <  -20 ~ '$I_{spp}^C > 1.2 \\times I_{FE}^C$',
                              diff <  -10 ~ '$I_{spp}^C > 1.1 \\times I_{FE}^C$',
                              diff >  +50 ~ '$I_{FE}^C > 1.5 \\times I_{spp}^C$',
                              diff >  +20 ~ '$I_{FE}^C > 1.2 \\times I_{spp}^C$',
                              diff >  +10 ~ '$I_{FE}^C > 1.1 \\times I_{spp}^C$',
                              TRUE ~ NA_character_))
...
``` {r}
brks <- c('$I_{spp}^C > 1.5 \\times I_{FE}^C$',
          '$I_{spp}^C > 1.2 \\times I_{FE}^C$',
          '$I_{spp}^C > 1.1 \\times I_{FE}^C$',
          '$I_{FE}^C > 1.1 \\times I_{spp}^C$',
          '$I_{FE}^C > 1.2 \\times I_{spp}^C$',
          '$I_{FE}^C > 1.5 \\times I_{spp}^C$')
...
lgd_b_xy <- c(x = .96, y = .25, h = .09, w = .12)
...
fig_2 <- ggdraw() +
  ...
  draw_label('B', x = 0.002, y = .63, hjust = 0, vjust = 0, 
             size = 25, fontfamily = 'bentonbold') +
  draw_label('C', x = 0.002, y = .28, hjust = 0, vjust = 0, 
             size = 25, fontfamily = 'bentonbold') +
  draw_label('Climate', x = 0.05, y = .63, hjust = 0, vjust = 0, 
             size = 20, fontfamily = 'bentonbold') +
  draw_label('Non-climate', x = 0.05, y = .28, hjust = 0, vjust = 0, 
             size = 20, fontfamily = 'bentonbold') +
