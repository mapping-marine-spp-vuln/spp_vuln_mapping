---
title: "Figure SXXX: Maps of spp richness, functional richness, FD"
...
```{r Panel g funct overredundancy}
for_map <- ggplot() +
  ### plot data:
...
```{r spp richness vs funct div plots}
set.seed(42)
sample_df <- maps_df %>%
  sample_n(10000)
