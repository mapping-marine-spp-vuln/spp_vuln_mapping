...
plot_realm <- function(df, methods, labels, x_label) {
...
panel_a_SI <- plot_prov(df = meow_prov_chi_df, 
                        methods = c('chi_fe', 'chi_hab'), 
                        labels = lbls, x_label = 'Cumulative (%ile)',
                        strips = FALSE)

panel_b_SI <- plot_prov(df = meow_prov_chi_df, 
                        methods = c('chi_fe_climate', 'chi_hab_climate'), 
                        labels = lbls, x_label = 'Climate (%ile)',
                        strips = FALSE)

panel_c_SI <- plot_prov(df = meow_prov_chi_df, 
                        methods = c('chi_fe_noncc', 'chi_hab_noncc'), 
                        labels = lbls, x_label = 'Non-climate (%ile)',
                        strips = TRUE)
