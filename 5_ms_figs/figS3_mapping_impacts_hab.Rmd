...
ggsave(filename = 'figSXXXB_hab_legend_w_pcts.png', plot = si_fig, height = 3, width = 3, units = 'in', dpi = 300)
```

```{r}
figSXXXA <- magick::image_read('figSXXXA_spp_legend_w_pcts.png')
figSXXXB <- magick::image_read('figSXXXB_hab_legend_w_pcts.png')
...
ggdraw() +
  ...
  draw_label('B', x = 0.51, y = .98, hjust = 0, vjust = 1, 
             size = 12, fontfamily = 'Helvetica', fontface = 'bold')
ggsave('figSXXX_combined_legend_w_pcts.png', width = 4, height = 2)
