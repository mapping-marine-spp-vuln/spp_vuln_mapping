...
fig5_labels <- fig5_panels +
  ...
  draw_label('C. Climate', x = c['x'], y = c['y'] + p_h,  hjust = 0, vjust = 0, 
             size = 12, fontfamily = 'Arial', fontface = 'bold') +
  draw_label('D. Non-climate', x = 1,      y = d['y'] + p_h,  hjust = 1, vjust = 0, 
             size = 12, fontfamily = 'Arial', fontface = 'bold')
```
...
fig5_legends <- fig5_labels +
  ...
  draw_label('A-B: Funct. entity vs.\nspecies impacts\n(quartiles)',
  ...
  draw_label('C-D: Funct. entity vs. species impacts',
             x = .24, y = .185, hjust = 0.5, vjust = 1, angle = 0,
             size = 10, color = 'black', fontfamily = 'Arial', fontface = 'bold') +
  draw_label('← spp > FE',
             x = .093, y = .156, hjust = 0, vjust = 1, angle = 0,
             size = 8, color = 'black', fontfamily = 'Arial', fontface = 'bold') +
  draw_label('FE > spp →',
             x = .405, y = .156, hjust = 1, vjust = 1, angle = 0,
             size = 8, color = 'black', fontfamily = 'Arial', fontface = 'bold')


ggsave(fig5_file, width = 6.25, height = 5.2, units = 'in', dpi = 300)
ggsave(fig5_file %>% str_replace('.png$', '.tif'), width = 6.25, height = 5.2, units = 'in', dpi = 300)
