...
```{r gather pieces}
figS4_file <- here('5_ms_figs/figS4_mapping_impacts_hab.png')
...
ggsave(figS4_file, width = fig_w, height = fig_h, units = 'in', dpi = 300)

knitr::include_graphics(figS4_file)
```
