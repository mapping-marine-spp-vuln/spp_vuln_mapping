---
title: "Figure S2: Maps of Habitat CHI"
...
chi_brks <- c(0, .2, .5, 1, 2, 5, round(max(chi_hab_df$chi), 1))
...
### Panel D: habitat climate vs nonclimate bivariate plot
...
```{r gather pieces}
figS2_file <- here('5_ms_figs/figS2_mapping_impacts_hab.png')
...
figS2_labels <- figS2_panels +
  draw_label('A. All stressors', x = a['x'], y = a['y'] + p_h,  hjust = 0, vjust = 0, 
             size = 9, fontfamily = 'Helvetica', fontface = 'bold') +
  draw_label('B. Climate stressors', x = 1,      y = b['y'] + p_h + .005,  hjust = 1, vjust = 0, 
             size = 9, fontfamily = 'Helvetica', fontface = 'bold') +
  draw_label('C. Non-climate stressors', x = c['x'], y = c['y'] + p_h + .005,  hjust = 0, vjust = 0, 
             size = 9, fontfamily = 'Helvetica', fontface = 'bold') +
  draw_label('D. Climate vs. non-climate', x = 1,      y = d['y'] + p_h + .005,  hjust = 1, vjust = 0, 
             size = 9, fontfamily = 'Helvetica', fontface = 'bold')
```
...
ggsave(figS2_file, width = 12, height = 10, units = 'cm', dpi = 300)
