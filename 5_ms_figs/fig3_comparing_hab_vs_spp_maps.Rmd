...
fig3_panels <- ggdraw() +
  ...
  draw_label('Species vs. Habitat\nimpacts (quartiles)',
             ...
             size = 10, color = 'black', fontfamily = 'Helvetica', fontface = 'bold') +
  draw_label('Habitat →', 
             x = lgd_xy['x'], y = lgd_xy['y'] - .005, 
             hjust = 0, vjust = 1, angle = 0,
             size = 8, color = 'black', fontfamily = 'Helvetica', fontface = 'bold') +
  draw_label('Species →', 
             x = lgd_xy['x'] - .005, y = lgd_xy['y'], 
             hjust = 0, vjust = 0, angle = 90,
             size = 8, color = 'black', fontfamily = 'Helvetica', fontface = 'bold')

ggsave(fig3_file, width = plot_w, height = plot_h, units = 'in', dpi = 300)
ggsave(fig3_file %>% str_replace('.png$', '.tif'), width = plot_w, height = plot_h, units = 'in', dpi = 300)
