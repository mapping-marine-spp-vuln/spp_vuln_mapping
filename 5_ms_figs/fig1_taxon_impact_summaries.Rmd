...
panel_a <- ggplot(cc_imp, aes(x = imp, y = taxon)) +
...
fig1 <- ggdraw() +
  ### draw panels:
  draw_plot(panel_a_plot,  x = 0.00, y = 0.00, height = 1.00, width = 0.56) +
  draw_plot(panel_b_plot,  x = 0.56, y = 0.00, height = 1.00, width = 0.44) +
  ### draw legends:
  ...
  draw_label('B', x = 0.56, y = .99, hjust = 0, vjust = 1, 
             size = 10, fontfamily = 'bentonbold')
