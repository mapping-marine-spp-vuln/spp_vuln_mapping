...
p1 <- ggplot(plot_df, aes(x = var, y = n)) +
  ...
  theme(legend.title = element_text(angle = 90, face = 'bold', vjust = 1),
...
```{r}
p <- plot_grid(p1, p2, labels = 'AUTO', label_size = 10, rel_widths = c(57, 43))

fig_f <- here('5_ms_figs/figSI_trait_imputation.png')
