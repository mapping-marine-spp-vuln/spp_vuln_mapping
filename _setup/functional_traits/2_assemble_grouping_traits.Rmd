...
Reproduction traits here are directly from FishBase, not gapfilled using taxa-level mean imputation.
...
traits_premice_all <- traits3_all %>%
  ...
  select(species, log_l, log_f, troph, age_mat, wcol, adult_mob) %>%
