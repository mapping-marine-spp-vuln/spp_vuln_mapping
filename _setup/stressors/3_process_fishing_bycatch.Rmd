...
```{r bycatch ratios, eval = FALSE, include = FALSE}
for(i in 1:nrow(gear_short_df)) {
  ### i <- 1
  g_name <- gear_short_df$name[i]
  g_water_col <- ifelse(g_name %in% benthic_gears, 'benth', 'pel')
...
#          50%          90%          95%          99%        99.9%         100% 
# 0.0007091492 0.0196607281 0.0472818584 0.1903854619 0.9999991162 1.0000000000 
...
#          50%          90%          95%          99%        99.9%         100% 
# 0.000000e+00 8.043595e+00 9.285327e+01 9.891995e+02 8.660429e+03 2.399188e+05 

ben_rescaled_r <- rescale_stressor(ben_normalized_r, qtile = .999)
# get_qtiles(ben_rescaled_r)
#          50%          90%          95%          99%        99.9%         100% 
# 0.0000000000 0.0009287756 0.0107215559 0.1142206140 0.9999968780 1.0000000000 
