...
plot(r, axes = FALSE, 
     main = 'Nutrient pollution rescaled to 99.9%ile')
...
plot(r, axes = FALSE,
     main = 'Human population density rescaled to 99.9%ile')
...
```{r create combined size-weighted ship layer}
...
See shipping pre-processing script?

* dir: `/home/shares/ohi/spp_vuln/spp_vuln_mapping/stressors/ship_density/aggregated`
    * file: `shipdensity_oilgas_masked_agg.tif`
