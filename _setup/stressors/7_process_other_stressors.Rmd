...
```{r}
extreme_sst_f <- here_ohi('stressors_2021/_dataprep/SST_past_present/final_extreme', 
                          'sst_exceeds_90quant_2016-2020.tif')
file.exists(extreme_sst_f)

extreme_sst_r <- raster(extreme_sst_f)
...
if(!file.exists(oa_f)) {
  ...
  ### project to 10 km
  oa_r <- projectRaster(orig_r, ocean_rast, progress = 'text')
