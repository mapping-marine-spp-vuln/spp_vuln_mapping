...
loop_over_clusts <- function(k_vec = 6:200, HC, DM) {
...
silh_df_ward1 <- loop_over_clusts(HC = rf_hclust_ward1,
                                  DM = dissim_mtx)
ggplot(silh_df_ward1, aes(x = k, y = silh)) +
  geom_point() +
  labs(x = "Number of clusters K, method = ward.D",
       y = "Average Silhouette (hierarch cluster)") +
  ylim(c(0, NA)) +
  theme_minimal()

silh_df_ward2 <- loop_over_clusts(HC = rf_hclust_ward2,
                                  DM = dissim_mtx)
ggplot(silh_df_ward2, aes(x = k, y = silh)) +
  geom_point() +
  labs(x = "Number of clusters K, method = ward.D2",
       y = "Average Silhouette (hierarch cluster)") +
  ylim(c(0, NA)) +
  theme_minimal()

silh_df_compl <- loop_over_clusts(HC = rf_hclust_compl,
                                  DM = dissim_mtx)
ggplot(silh_df_compl, aes(x = k, y = silh)) +
  geom_point() +
  labs(x = "Number of clusters K, method = complete",
       y = "Average Silhouette (hierarch cluster)") +
  ylim(c(0, NA)) +
  theme_minimal()

silh_df_singl <- loop_over_clusts(HC = rf_hclust_singl,
                                  DM = dissim_mtx)
ggplot(silh_df_singl, aes(x = k, y = silh)) +
  geom_point() +
  labs(x = "Number of clusters K, method = single",
       y = "Average Silhouette (hierarch cluster)") +
  ylim(c(0, NA)) +
  theme_minimal()

silh_df_avg <- loop_over_clusts(HC = rf_hclust_avg,
                                DM = dissim_mtx)
ggplot(silh_df_avg, aes(x = k, y = silh)) +
  geom_point() +
  labs(x = "Number of clusters K, method = average",
       y = "Average Silhouette (hierarch cluster)") +
  ylim(c(0, NA)) +
  theme_minimal()
...
* Wards D and D2 start near 0.15 and continue to increase with number of clusters
* Complete linkage shows discrete jumps at certain numbers of clusters
* Single linkage starts near 0.04 and hovers close
