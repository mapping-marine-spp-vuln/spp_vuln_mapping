...
vuln1_mean_fs <- list.files(here('_output/vuln_maps/vuln_maps_by_species'), 
...
vuln1_sd_fs <- list.files(here('_output/vuln_maps/vuln_maps_by_species'), 
...
for(i in 1:nrow(str_vuln_lookup)) {
  ...
  f_stem <- here('_output/impact_maps/impact_maps_species', 
...
imp_map_dir <- here('_output/impact_maps/impact_maps_species')
...
```{r}
vuln2_mean_fs <- list.files(here('_output/vuln_maps/vuln_maps_by_funct_entity'), 
                       pattern = 'mean.tif', full.names = TRUE)
...
vuln2_sd_fs <- list.files(here('_output/vuln_maps/vuln_maps_by_funct_entity'), 
                       pattern = 'sdev.tif', full.names = TRUE)
...
for(i in 1:nrow(str_vuln_lookup)) {
  ...
  f_stem <- here('_output/impact_maps/impact_maps_funct_entity', 
...
imp_map_dir <- here('_output/impact_maps/impact_maps_funct_entity')
...
mean_unwt_fs <- list.files(here('_output/impact_maps/impact_maps_species'), 
                           pattern = '_mean.tif', full.names = TRUE)
mean_fvwt_fs <- list.files(here('_output/impact_maps/impact_maps_funct_entity'), 
                           pattern = '_mean.tif', full.names = TRUE)

focal_strs <- c('microplastic', 'wildlife_strike',
                'nutrient_pollution', 'ocean_acidification', 
                'habitat_loss_degradation', 'marine_heat_wave',
                'light_pollution')
ocean_mask <- terra::rast(here('_spatial/ocean_area_mol.tif'))
