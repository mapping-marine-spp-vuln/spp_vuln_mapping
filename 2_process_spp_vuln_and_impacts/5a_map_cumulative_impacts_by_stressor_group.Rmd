...
spp_outfile_stem <- here('_output/impact_maps/cumulative_maps/species_group_chi_%s.tif')
...
fe_outfile_stem <- here('_output/impact_maps/cumulative_maps/funct_entity_group_chi_%s.tif')
