...
impact_map_stem <- here('_output/impact_maps/impact_maps_species', 
...
rast_fe_out_stem <- here('_output/impact_maps/impact_maps_funct_entity', 
...
if(any(!file.exists(rast_mean_impact_fe_f, rast_sdev_impact_fe_f))) {
  ...
  mean_rast_fe <- map_to_mol(impact_map_df, by = 'cell_id', which = 'fe_mean_impact')
  sdev_rast_fe <- map_to_mol(impact_map_df, by = 'cell_id', which = 'fe_sd_impact')
