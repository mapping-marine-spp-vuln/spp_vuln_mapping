...
Even with all this, we get only ~1200 distinct species, at least some of which are freshwater.  Let's instead use the vulnerability trait information.
